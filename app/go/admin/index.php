  ...
  <div class="row">
    <div class="col">
      <?php if(isset($_GET['detail']) && $_GET['detail'] == 'deleteUserNotFound') { ?>
        <div class="alert alert-danger" role="alert">There was an error deleting the user<?php if($_GET['detail']) {print(": " . h($_GET['detail']));}; ?></div>
      <?php } ?>
    </div>
  </div>
<?php } ?>
      ...
      <tbody>
        ...
        <?php foreach($users as $user) { ?>
          <tr>
            ...
            <td><?php print(h($user['FirstName']) . ' ' . h($user['LastName'])); ?></td>
            <td><?php if($user['Isadmin']) {print("Administrator");} else {print("Visitor");} ?></td>
            <td><?php if($user['Isadmin']) { } else {?>
              <a href="/go/admin/user/edit.php?id=<?php print((int)$user['Id']); ?>">
              ...
              <a href="/go/admin/user/delete.php?id=<?php print((int)$user['Id']); ?>">
